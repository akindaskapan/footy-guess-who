        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full h-12 rounded-xl border border-border bg-card flex items-center justify-center gap-3 font-display font-semibold text-sm text-foreground transition-transform active:scale-[0.98] hover:bg-secondary"
            >
